...
VALUES
    ...
    (2, 1, 4, 4, '2021-05-25 11:30:00', '박지영', '010-1111-2222', '인천시 남구 만수동', '조심히 배달해주세요', '98765', '신용카드', 67250, 'PAID', 'IMMEDIATE', 7, 'INV004'),
    (2, 4, 4, 5, '2021-05-25 11:30:00', '박지영', '010-1111-2222', '인천시 남구 만수동', '조심히 배달해주세요', '98765', '신용카드', 191340, 'DELIVER_DONE', 'IMMEDIATE', 7, 'INV004'),
    (3, 2, 5, 6, '2022-05-27 13:20:00', '김지원', '010-7777-8888', '광주시 서구 쌍촌동', '비닐 포장해주세요', '24680', '신용카드', 958680, 'PAID', 'IMMEDIATE', 9, 'INV006'),
    (3, 3, 5, 7, '2022-05-27 13:20:00', '김지원', '010-7777-8888', '광주시 서구 쌍촌동', '비닐 포장해주세요', '24680', '신용카드', 63830, 'DELIVER_DONE', 'IMMEDIATE', 9, 'INV006'),
    (3, 2, 5, 8, '2022-05-27 13:20:00', '김지원', '010-7777-8888', '광주시 서구 쌍촌동', '비닐 포장해주세요', '24680', '신용카드', 372450, 'PAID', 'IMMEDIATE', 9, 'INV006'),
    (3, 1, 5, 9, '2022-05-27 13:20:00', '김지원', '010-7777-8888', '광주시 서구 쌍촌동', '비닐 포장해주세요', '24680', '신용카드', 306800, 'DELIVERING', 'IMMEDIATE', 9, 'INV006'),
    (4, 4, 6, 10, '2023-01-31 16:55:00', '정민우', '010-6666-7777', '대구시 수성구 만촌동', '조심히 다뤄주세요', '35791', '신용카드', 124880, 'FINISH', 'IMMEDIATE', 11, 'INV010'),
    (4, 3, 6, 11, '2023-01-31 16:55:00', '정민우', '010-6666-7777', '대구시 수성구 만촌동', '조심히 다뤄주세요', '35791', '신용카드', 109570, 'DELIVER_DONE', 'IMMEDIATE', 11, 'INV010'),
    (5, 2, 7, 12, '2023-02-02 09:40:00', '김민서', '010-9876-5432', '광주시 북구 산정동', '상품에 표시된 번호로 연락주세요', '26748', '신용카드', 60, 'DELIVER_DONE', 'IMMEDIATE', 6, 'INV012'),
    (5, 1, 7, 12, '2023-02-02 09:40:00', '김민서', '010-9876-5432', '광주시 북구 산정동', '상품에 표시된 번호로 연락주세요', '26748', '신용카드', 74850, 'DELIVERING', 'IMMEDIATE', 6, 'INV012'),
    (6, 4, 8, 14, '2023-02-03 13:05:00', '박민서',  '010-5555-5555', '울산시 중구 성안동', '부드럽게 다뤄주세요', '59374', '무통장 입금', 47580, 'PAID', 'IMMEDIATE', 5, 'INV013'),
    (6, 4, 8, 14, '2023-02-03 13:05:00', '박민서', '010-5555-5555', '울산시 중구 성안동', '부드럽게 다뤄주세요', '59374', '무통장 입금', 36760, 'DELIVER_DONE', 'IMMEDIATE', 5, 'INV013'),
    (7, 2, 8, 15, '2023-02-05 12:50:00', '김민준', '010-3333-4444', '대전시 중구 대흥동', '옷을 접혀서 배달해주세요', '73984', '신용카드', 91450, 'DELIVER_DONE', 'IMMEDIATE', 9, 'INV015'),
    (7, 3, 8, 16, '2023-02-05 12:50:00', '김민준', '010-3333-4444', '대전시 중구 대흥동', '옷을 접혀서 배달해주세요', '73984', '신용카드', 93500, 'DELIVER_DONE', 'IMMEDIATE', 9, 'INV015'),
    (7, 3, 8, 16, '2023-02-05 12:50:00', '김민준', '010-3333-4444', '대전시 중구 대흥동', '옷을 접혀서 배달해주세요', '73984', '신용카드', 217455, 'FINISH', 'IMMEDIATE', 9, 'INV015'),
    (8, 1, 9, 17, '2023-02-10 16:30:00', '임수경', '010-9999-8888', '부산시 북구 덕천동', '부품은 한 묶음으로', '62835', '신용카드', 159850, 'PAID', 'IMMEDIATE', 13, 'INV017'),
    (8, 3, 9, 18, '2023-02-10 16:30:00', '임수경', '010-9999-8888', '부산시 북구 덕천동', '부품은 한 묶음으로', '62835', '신용카드', 57800, 'DELIVERING', 'IMMEDIATE', 13, 'INV017'),
    (9, 2, 10, 19, '2023-02-15 10:30:00', '김우진', '010-4444-3333', '제주시 한림읍 월령리', '건물 앞에서 연락주세요', '69016', '무통장 입금', 137910, 'DELIVER_DONE', 'IMMEDIATE', 15, 'INV019'),
    (10, 5, 11, 20, '2023-02-20 14:54:00', '이하늘', '010-7777-6666', '대구시 달서구 진천동', '오후 2시 이후 전화 부탁', '57139', '신용카드', 249073, 'FINISH', 'IMMEDIATE', 8, 'INV020');
...
Values (4, 4, "편백나무침대", "흰색을 사고싶다.", 40, "23-05-20", "23-05-30", "이연희", "1087-1087", "최대한 빨리 답변주세요.", "imageDirectory", "WAIT", '2022-04-14 12:00:00', now()),
       (4, 3, "친환경칫솔", "대나무로 만든것", 30, "23-05-20", "23-05-30", "황슬찬", "1541-1541", "생분해되는 제품으로 알아봐주세요.", "imageDirectory", "WAIT", '2023-05-20 12:00:00', now()),
       (4, 10, "우산", "접이식", 20, "23-05-20", "23-05-30", "김인후", "8282-8282", "색상 어떤것들이 있는지 미리 말씀해주세요.", "imageDirectory", "WAIT", '2023-03-20 12:00:00', now()),
       (4, 1, "머리빗", "휴대용", 10, "23-05-20", "23-05-30", "이연희", "managerCall", "휴대용으로 작은것 구해주세요.", "imageDirectory", "WAIT", '2023-01-20 12:00:00', now()),
       ...
       (6, 10, "우산", "접이식", 20, "23-05-20", "23-05-30", "김인후", "8282-8282", "색상 어떤것들이 있는지 미리 말씀해주세요.", "imageDirectory", "WAIT", '2023-03-20 12:00:00', now()),
       (6, 1, "머리빗", "휴대용", 10, "23-05-20", "23-05-30", "이연희", "managerCall", "휴대용으로 작은것 구해주세요.", "imageDirectory", "WAIT", '2023-01-20 12:00:00', now()),
       (6, 5, "컴퓨터", "고성능 게임용 컴퓨터", 1, "23-05-22", "23-05-30", "홍길동", "1234-5678", "게임용으로 고성능을 원합니다.", "imageDirectory", "WAIT", '2023-02-20 12:00:00', now()),
       (6, 10, "전자레인지", "800W, 흰색", 2, "23-05-23", "23-05-30", "이순신", "9876-5432", "사용법을 자세히 알려주세요.", "imageDirectory", "WAIT", '2023-01-22 12:00:00', now()),
       (5, 5, "선풍기", "2단 선풍기", 5, "23-05-25", "23-06-01", "김철수", "4567-8901", "저렴한 가격으로 구매하고 싶습니다.", "imageDirectory", "WAIT", '2023-04-20 12:00:00', now()),
       (5, 5, "커피머신", "자동으로 커피 내릴 수 있는 기능이 있는 제품", 3, "23-05-26", "23-06-02", "박영희", "7890-1234", "커피를 좋아해서 커피머신을 구매하고 싶습니다.", "imageDirectory", "WAIT", '2023-03-20 12:00:00', now()),
       (7, 10, "운동화", "크기 250mm, 검정색", 1, "23-05-27", "23-06-03", "김영수", "5678-9012", "운동화 사이즈가 250mm인 제품을 찾고 있습니다.", "imageDirectory", "WAIT", '2023-04-20 12:00:00', now()),
       (8, 10, "휴대폰 케이스", "아이폰 12용 투명 케이스", 2, "23-06-04", "23-06-10", "정지원", "3456-7890", "아이폰 12용 투명 케이스를 구매하고 싶습니다.", "imageDirectory", "WAIT", '2023-05-20 12:00:00', now()),
       (9, 5, "노트북", "15인치, SSD 512GB", 1, "23-06-05", "23-06-11", "김태희", "2345-6789", "성능 좋은 15인치 노트북을 찾고 있습니다.", "imageDirectory", "WAIT", '2023-05-21 12:00:00', now()),
       (10, 10, "서적", "소설 책 3권 세트", 3, "23-06-19", "23-06-25", "이민호", "9012-3456", "소설 책 3권 세트를 구매하고 싶습니다.", "imageDirectory", "WAIT", '2023-06-01 12:00:00', now()),
       (3, 10, "의자", "회의용 의자", 6, "23-06-20", "23-06-26", "김지영", "7890-1234", "회의용으로 사용할 수 있는 의자를 찾고 있습니다.", "imageDirectory", "WAIT", '2023-06-02 12:00:00', now()),
       (4, 1, "책상", "목재로 만든 책상", 1, "23-06-21", "23-06-27", "김현우", "2345-6789", "목재로 만든 책상을 찾고 있습니다.", "imageDirectory", "WAIT", '2023-06-03 12:00:00', now()),
       (5, 5, "의자", "패브릭 소재의 의자", 4, "23-06-28", "23-07-04", "이나은", "7890-1234", "패브릭 소재의 의자를 구매하고 싶습니다.", "imageDirectory", "WAIT", '2023-06-04 12:00:00', now()),
       (6, 5, "컴퓨터", "고성능 게임용 컴퓨터", 1, "23-06-29", "23-07-05", "이동욱", "5678-9012", "고성능 게임용 컴퓨터를 찾고 있습니다.", "imageDirectory", "WAIT", '2023-06-05 12:00:00', now()),
       (7, 10, "휴대폰 케이스", "아이폰 12용 투명 케이스", 2, "23-07-12", "23-07-18", "김태형", "3456-7890", "아이폰 12용 투명 케이스를 구매하고 싶습니다.", "imageDirectory", "WAIT", '2023-06-15 12:00:00', now()),
       (8, 10, "노트북", "15인치, SSD 512GB", 1, "23-07-13", "23-07-19", "김수현", "2345-6789", "성능 좋은 15인치 노트북을 찾고 있습니다.", "imageDirectory", "WAIT", '2023-06-16 12:00:00', now()),
       (9, 5, "선풍기", "2단 선풍기", 5, "23-07-27", "23-08-02", "박서준", "4567-8901", "선풍기를 저렴한 가격으로 구매하고 싶습니다.", "imageDirectory", "WAIT", '2023-07-10 12:00:00', now()),
       (10, 5, "커피머신", "자동으로 커피 내릴 수 있는 기능이 있는 제품", 3, "23-07-28", "23-08-03", "김하늘", "7890-1234", "커피를 좋아해서 커피머신을 구매하고 싶습니다.", "imageDirectory", "WAIT", '2023-07-11 12:00:00', now()),
       ...
       (4, 10, "의자", "회의용 의자", 6, "23-07-30", "23-08-05", "김유라", "7890-1234", "회의용으로 사용할 수 있는 의자를 찾고 있습니다.", "imageDirectory", "WAIT", '2023-07-13 12:00:00', now());
...
Values (3, 1, "운동복", "등에 '한사랑 산악회'라고 새겨주세요.", 10, "23-05-20", "23-05-30", "조갑수", "managerCall", "개인적으로 필요해서", "imageDirectory", "WAIT", '2022-12-20 12:00:00', now()),
       ...
       (4, 2, "립스톱 백팩", "각 컬러에 해당하는 로고를 새겨주세요.", 15, "23-06-05", "23-06-15", "이재용", "managerCall3", "여행용", "imageDirectory3", "WAIT","2023-03-30 16:00:00", now()),
       (4, 2, "티셔츠", "school_name 아래 '시립 대학교' 프린트주세요.", 100, "23-06-10", "23-06-20", "홍미숙", "managerCall4", "대학 행사용", "imageDirectory4", "WAIT", '2023-01-05 09:00:00', now()),
       (4, 2, "이어폰", "브랜드 로고를 인쇄해주세요.", 12, "23-06-15", "23-06-25", "박상규", "managerCall5", "음질이 좋은 것으로 부탁드립니다.", "imageDirectory5", "WAIT", '2023-02-01 17:00:00', now()),
       (4, 2, "체육복", "구단 멤버들을 위한 디자인", 28, "23-06-20", "23-06-30", "민경부장", "managerCall6", "편안한 착용감", "imageDirectory6", "WAIT", '2023-06-30 11:00:00', now()),
       (5, 2, "후드티", "[회사명] 자존심 배틀라운드 퀘스트 팀", 25, "23-06-25", "23-07-05", "황건립", "managerCall7", "직원 팀플레이 격려", "imageDirectory7", "WAIT", '2023-01-20 15:30:00', now()),
       (5, 3, "클립보드", "플라스틱 소재", 35, "23-02-05", "23-02-15", "열혈산신", "managerCall8", "학교 강의용", "imageDirectory8", "WAIT", '2022-10-05 14:15:00', now()),
       (5, 3, "숄더백", "회사 이벤트에 사용할 예정", 50, "23-07-01", "23-07-10", "장태산", "managerCall9", "50개 주문합니다.", "imageDirectory9", "WAIT", '2023-08-23 08:00:00', now()),
       (6, 3, "노트북 가방", "브랜드 로고를 인쇄해주세요.", 45, "23-07-05", "23-07-15", "김유리", "managerCall10", "비즈니스용", "imageDirectory10", "WAIT", '2022-07-14 12:07:00', now()),
       (6, 3, "보조 배터리", "회사 로고 인쇄 부탁드립니다.", 20, "23-03-06", "23-03-16", "최수진", "managerCall11", "여행용으로 든든한 용량", "imageDirectory11", "WAIT", '2023-03-05 20:50:00', now()),
       (6, 3, "텀블러", "제품 단체 주문합니다.", 22, "23-07-10", "23-07-20", "이호분", "managerCall12", "사무실에서 사용", "imageDirectory12", "WAIT", '2023-05-12 18:00:00', now()),
       (6, 3, "비치타올", "요가 수업 때 사용할 예정", 15, "23-07-12", "23-07-22", "김진희", "managerCall13", "깔금하게 포장해주세요.", "imageDirectory13", "WAIT", '2022-08-11 12:08:00', now()),
       (7, 3, "우산", "프린트 요청드립니다.", 60, "23-07-18", "23-07-28", "김연옥", "managerCall14", "비올때 사용할 것", "imageDirectory14", "WAIT", '2023-10-16 13:00:00', now()),
       (7, 1, "깃털 배드민턴 셔틀콕", "단체 팀 대회에 사용", 80, "23-07-23", "23-08-02", "이주환", "managerCall15", "팀 대회용", "imageDirectory15", "WAIT", '2023-07-26 16:00:00', now()),
       (7, 1, "마린 스포츠 원피스", "연회용 마린 스포츠 원피스 새겨주세요.", 20, "23-07-28", "23-08-07", "김송이", "managerCall16", "S, M, L 단위로 구매", "imageDirectory16", "WAIT", '2023-02-07 14:00:00', now()),
       (8, 1, "울 코트", "겨울 시즌 착용", 25, "23-08-01", "23-08-11", "최창민", "managerCall17", "두께가 평균적인 것으로", "imageDirectory17", "WAIT", '2023-11-30 16:00:00', now()),
       (9, 1, "동아리 후드티", "직각트로이카 동아리 전용 의상", 30, "23-08-05", "23-08-15", "서영화", "managerCall18", "남녀 모두 사용 가능", "imageDirectory18", "WAIT", '2022-12-25 21:00:00', now()),
       (10, 2, "슬리퍼", "비치용 슬리퍼 디자인", 30, "23-08-10", "23-08-20", "곽철기", "managerCall19", "사이즈별로 주문합니다.", "imageDirectory19", "WAIT", '2023-03-19 16:00:00', now()),
       (11, 2, "스타일리시 보트 슈즈", "상업용 디자인", 15, "23-08-15", "23-08-25", "박수영", "managerCall20", "적절한 사이즈별 대응", "imageDirectory20", "WAIT", '2023-04-20 15:00:00', now()),
       (10, 2, "브로치", "공식 행사용으로 디자인", 18, "23-08-17", "23-08-27", "강미숙", "managerCall21", "물놀이장에서 사용될 예정", "imageDirectory21", "WAIT", '2023-05-20 09:00:00', now());
...
VALUES (9, 1, "다이써", "선우연희", "1234-1234", "5421534", "문구류", 2000, "저희 회사만의 기술력으로 잉크가 오래갑니다.", "imageDirectory", "WAIT", '2020-03-10 12:00:00', now()),
       (9, 2, "네이클로버", "황우슬찬", "4321-4321", "5444534", "운동복", 2000, "친환경 제품을 판매하고 있습니다.", "imageDirectory", "WAIT", '2022-12-01 12:00:00', now()),
       (9, 3, "규글", "제갈인후", "3333-22222", "34357788", "뷰티제품", 2000, "비건 화장품을 판매하고 있습니다.", "imageDirectory", "WAIT", '2023-02-21 12:00:00', now()),
       (8, 4, "삼섬", "연찬후", "1111-1111", "67686796", "침구류", 2000, "introduction", "imageDirectory", "WAIT", '2021-02-21 12:00:00', now()),
       (8, 5, "스카이패션", "정철수", "5647-7580", "8213587", "가방류", 1998, "다양한 스타일의 가방을 판매합니다.", "imageDirectory5", "WAIT", '2021-07-10 10:00:00', now()),
       (8, 6, "에이페이퍼", "이영희", "7890-5874", "9512957", "문구류", 2015, "친환경적인 문구류 전문점", "imageDirectory6", "WAIT", '2020-09-15 15:00:00', now()),
       (8, 7, "랩탑스머프", "서익준", "3481-2301", "9267848", "테크 기기", 2016, "하이테크 디바이스를 판매합니다.", "imageDirectory7", "WAIT", '2019-08-25 13:30:00', now()),
       (8, 8, "튜브시스터즈", "장희은", "1120-8555", "8735927", "뷰티제품", 2010, "고품질 화장품을 전문으로 합니다.", "imageDirectory8", "WAIT", '2021-06-18 10:00:00', now()),
       ...
       (4, 6, "피카소", "김지훈", "3874-3659", "5632736", "미술 용품", 2008, "미술 용품 전문점", "imageDirectory13", "WAIT", '2022-10-02 11:00:00', now()),
       (4, 4, "스포티원", "이준호", "8790-0011", "8362519", "스포츠 용품", 2005, "종합 운동 기구 판매점", "imageDirectory14", "WAIT", '2021-09-20 19:00:00', now()),
       (4, 5, "글라스코", "최하연", "6654-2334", "4521674", "안경류", 2014, "감각적인 안경 프레임 판매", "imageDirectory15", "WAIT", '2019-03-21 10:00:00', now()),
       (4, 1, "극장맨", "장기욱", "7557-3311", "6782293", "영화 굿즈", 2017, "영화 팬들을 위한 굿즈 전문점", "imageDirectory16", "WAIT", '2019-12-15 13:00:00', now()),
       (5, 5, "타임어택", "이수정", "6677-9873", "9268883", "시계류", 2002, "고급 시계 판매점", "imageDirectory17", "WAIT", '2020-09-13 20:00:00', now()),
       (5, 5, "오가닉힐", "안민영", "7429-7814", "5949534", "유기농 식품", 2020, "건강을 위한 유기농 식품", "imageDirectory18", "WAIT", '2023-02-01 09:00:00', now()),
       (5, 4, "포스트건", "임한결", "2662-4368", "4123367", "건축자재", 2006, "건축에 필요한 자재를 깔끔하게", "imageDirectory19", "WAIT", '2022-12-01 12:00:00', now()),
       (5, 5, "매직키친", "고수지", "7714-6334", "8467315", "주방용품", 2001, "갖춰진 주방이 좋은 요리의 시작", "imageDirectory20", "WAIT", '2018-10-21 14:00:00', now()),
       (6, 3, "귀염덩어리", "신동욱", "1324-1674", "1285324", "애완용품", 2004, "사랑스러운 애완동물용품 판매", "imageDirectory21", "WAIT", '2020-08-15 16:00:00', now()),
       (6, 3, "튜얼단계", "선우장원", "7789-8844", "9647437", "음주류", 1995, "나만 알고 싶은 작은 제조사 와인", "imageDirectory22", "WAIT", '2021-01-22 11:00:00', now()),
       (6, 7, "리디룸", "김학교", "5957-4321", "9645737", "인테리어 소품", 2007, "인테리어 아이디어를 주는 소품들", "imageDirectory23", "WAIT", '2019-06-02 18:00:00', now()),
       (6, 7, "도트게임", "이예나", "6567-7765", "2345244", "보드 게임", 2012, "여러 가족들과 즐길 수 있는 게임보드", "imageDirectory24", "WAIT", '2018-03-05 19:00:00', now());