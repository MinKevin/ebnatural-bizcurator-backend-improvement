...
public class JwtKey {
    ...
    private static final Map<String, String> SECRET_KEY_SET = Map.of(
            "key1", "HowCanIMakeJWTKeyRollingAsAutoCreatedHowCanIMakeJWTKeyRollingAsAutoCreatedHowCanIMakeJWTKeyRollingAsAutoCreatedHowCanIMakeJWTKeyRollingAsAutoCreated",
